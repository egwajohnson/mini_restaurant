...
export class CouponRepository {
    ...
    static applyCoupon = async (userId: Types.ObjectId, couponCode: string, minOrderValue: number) => {
        const coupon = await couponModel.findById({userId,couponCode,minOrderValue});
        return coupon;
    }
